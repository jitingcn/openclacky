...
const I18n = (() => {
  ...
  const TRANSLATIONS = {
    en: {
      ...
      "settings.models.compressionOverrides.title":        "Compression Overrides",
      "settings.models.compressionOverrides.hint":         "(leave blank to use global defaults)",
      "settings.models.compressionOverrides.tokenThreshold": "Token Threshold",
      "settings.models.compressionOverrides.messageThreshold": "Message Threshold",
      "settings.models.compressionOverrides.maxRecent":     "Max Recent Messages",
      "settings.models.compressionOverrides.targetTokens":  "Target Tokens",
      "settings.models.compressionOverrides.idleThreshold": "Idle Min Tokens",
      "settings.models.compressionOverrides.idleDelay":     "Idle Delay",
      "settings.models.compressionOverrides.useGlobal":     "Use global",
      ...
      "settings.compression.desc":             "Control when conversation history is automatically compressed to save tokens.",
      "settings.compression.enable":           "Enable Compression",
      "settings.compression.token_threshold":   "Token Threshold",
      "settings.compression.message_threshold": "Message Threshold",
      "settings.compression.max_recent":        "Max Recent Messages",
      "settings.compression.target_tokens":     "Target Tokens",
      "settings.compression.idle_threshold":    "Idle Compression Min Tokens",
      "settings.compression.idle_delay":        "Idle Delay",
      "settings.compression.save":              "Save Settings",
      "settings.compression.saved":             "✅ Saved",
      "settings.compression.saveFailed":        "❌ Save failed",
    ...
    zh: {
      ...
      "settings.models.compressionOverrides.title":        "压缩覆盖设置",
      "settings.models.compressionOverrides.hint":         "（留空则使用全局默认值）",
      "settings.models.compressionOverrides.tokenThreshold": "Token 阈值",
      "settings.models.compressionOverrides.messageThreshold": "消息数阈值",
      "settings.models.compressionOverrides.maxRecent":     "最大保留消息数",
      "settings.models.compressionOverrides.targetTokens":  "目标 Token 数",
      "settings.models.compressionOverrides.idleThreshold": "空闲最小 Token 数",
      "settings.models.compressionOverrides.idleDelay":     "空闲延迟",
      "settings.models.compressionOverrides.useGlobal":     "使用全局",
      ...
      "settings.compression.title":            "对话压缩",
      "settings.compression.desc":             "控制何时自动压缩对话历史以节省 token 消耗。",
      "settings.compression.enable":           "启用压缩",
      "settings.compression.token_threshold":   "Token 阈值",
      "settings.compression.message_threshold": "消息数阈值",
      "settings.compression.max_recent":        "保留最近消息数",
      "settings.compression.target_tokens":     "目标 Token 数",
      "settings.compression.idle_threshold":    "空闲压缩最小 Token 数",
      "settings.compression.idle_delay":        "空闲延迟",
      "settings.compression.save":              "保存设置",
      "settings.compression.saved":             "✅ 已保存",
      "settings.compression.saveFailed":        "❌ 保存失败",
