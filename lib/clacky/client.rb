  ...
  class Client
    ...
    def anthropic_connection
      @anthropic_connection ||= Faraday.new(url: @base_url) do |conn|
        ...
        # Mimic Claude Code client identity for aggregation proxy channel affinity.
        # Claude Code 2.1.x sends these headers; proxies identify and route
        # Claude Code requests by User-Agent + metadata.user_id in the body.
        conn.headers["User-Agent"]            = "claude-code/2.1.132"
